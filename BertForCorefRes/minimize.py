...
if __name__ == "__main__":
  ...
  file_name = sys.argv[6] if len(sys.argv) == 7 else None # optional
  print(do_lower_case)
  ...
  if not file_name:
    ...
    minimize_partition(file_name, 'english', "v4_gold_conll", labels, stats, tokenizer, seg_len, input_dir, output_dir)
